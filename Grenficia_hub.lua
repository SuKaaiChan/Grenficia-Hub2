local Fluent = loadstring(game:HttpGet("https://github.com/SuKaaiChan/Grenficia-Hub1/blob/main/Grenficia_hub.lua"))()
...
loadstring(game:HttpGet("https://github.com/SuKaaiChan/Grenficia-Hub1/blob/main/Grenficia_hub.lua"))()
